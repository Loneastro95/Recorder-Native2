...
const Login = ({ navigation }) =>{
    return(
        ...
        <View style={{backgroundColor: '#73beed', height: 198, marginBottom: 100}}>
        <View style={{alignSelf: 'center', alignItems: 'center', marginTop: 70}}>
          ...
          <View style={styles.container} >
            ...
            <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate('Recorder')}>Log In </TouchableOpacity>
          ...
          <Text style={{marginTop: 20, textAlign: 'center',}}> Don't have account? <TouchableOpacity onPress={() => navigation.navigate('Signup')}><Text style={{color: '#243670', fontWeight: 600}}>SignUp</Text></TouchableOpacity> </Text>
        </View>
    )
}
